...
Feature: Spritecloud — explore journey
  ...
  Scenario: Reload contact form after partial fill
    Given I am on the landing page
    When I navigate directly to "/contact"
  ...
  @journey:explore @priority:nice-to-have @llm-composed @kind:variant @model:qwen3-coder-next-latest
  Scenario: Navigate to /vciso via link, assert h1 and URL
    Given I am on the landing page
    When I click the link to "/vciso"
    Then the page title contains "vCISO"
    Then the main heading reads "Virtual Cyber Security Information Officer"
    Then the URL contains "/vciso"
