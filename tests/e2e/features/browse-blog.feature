...
Feature: Spritecloud — browse journey
  ...
  Scenario: Reload blog page after navigation
    Given I open the landing page
    When I click the link to "/blog"
  ...
  Scenario: Direct navigation to blog page
    Given I am not signed in
    When I navigate directly to "/blog"
    Then the page title contains "Blog"

  @journey:browse @priority:standard @llm-composed @kind:edge @model:qwen3-coder-next-latest
  Scenario: Blog page shows at least 3 posts
    Given I open the landing page
    When I click the link to "/blog"
    Then the page title contains "Blog"
