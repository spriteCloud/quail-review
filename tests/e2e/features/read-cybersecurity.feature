...
Feature: Spritecloud — read journey
  ...
  @journey:read @priority:nice-to-have @llm-composed @kind:nav @model:qwen3-coder-next-latest
  Scenario: Navigate to cybersecurity page and verify heading
  ...
  Scenario: Reload page after navigation preserves destination heading
    Given I am on the landing page
    When I click the link to "/cybersecurity"
  ...
  @journey:read @priority:nice-to-have @llm-composed @kind:edge @model:qwen3-coder-next-latest
  Scenario: Direct navigation to cybersecurity page loads correct content
    Given I open the page "/cybersecurity"
    Then I see the heading "Fully Tailored Cybersecurity."
    Then the page title contains "Penetration Testing"

  @journey:read @priority:nice-to-have @llm-composed @kind:variant @model:qwen3-coder-next-latest
  Scenario: Navigate to cybersecurity and verify no error shown
    Given I am on the landing page
    When I click the link to "/cybersecurity"
    Then no error message is shown in the form region
