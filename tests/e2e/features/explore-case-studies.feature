...
Feature: Spritecloud — explore journey
  ...
  @journey:explore @priority:nice-to-have @llm-composed @kind:nav @model:qwen3-coder-next-latest
  Scenario: Click case studies link
    Given I am on the landing page
    When I click the link to "case-studies"
    Then the page title contains "Case Studies"
    Then the URL contains "case-studies"

  @journey:explore @priority:nice-to-have @llm-composed @kind:state @model:qwen3-coder-next-latest
  Scenario: Reload on case studies page
    Given I open the page "case-studies"
  ...
  @journey:explore @priority:nice-to-have @llm-composed @kind:nav @model:qwen3-coder-next-latest
  Scenario: Browser history back from case studies
    Given I open the page "case-studies"
    When I go back in the browser history
