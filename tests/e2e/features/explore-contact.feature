...
Feature: Spritecloud — explore journey
  ...
  @journey:explore @priority:nice-to-have @llm-composed @model:qwen3-coder-next-latest
  Scenario: Navigate contact then submit empty form
    Given I open the page "/contact"
  ...
  @journey:explore @priority:nice-to-have @llm-composed @model:qwen3-coder-next-latest
  Scenario: Submit contact form and verify redirect
    Given I open the page "/contact"
