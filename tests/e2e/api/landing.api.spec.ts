 ...
 * Generated by quail.
 *
 * API contract test — verifies server behavior for form submissions
...
test.describe('Spritecloud — API contract @ https://www.spritecloud.com/', () => {
  ...
  test('@kind:api @smoke succeeds with realistic form data', async ({ request }) => {
  ...
  test('@kind:api @negative rejects missing required fields with a 4xx status', async ({ request }) => {
    const response = await request.get('https://www.spritecloud.com/', {
      form: {},
    })
  ...
  test('@kind:api @negative handles oversize input without crashing', async ({ request }) => {
  ...
  test('@kind:api @negative processes unicode input without crashing', async ({ request }) => {
    const response = await request.get('https://www.spritecloud.com/', {
      form: {
  ...
  test('@kind:api @negative rejects SQL injection attempts without crashing', async ({ request }) => {
  ...
  test('@kind:api @negative sanitizes or rejects XSS attempts', async ({ request }) => {
  ...
  test('@kind:api @negative handles null-byte injection attempts without crashing', async ({ request }) => {
    const response = await request.get('https://www.spritecloud.com/', {
      form: {
  ...
  test('@kind:api @negative manages burst traffic gracefully (either rate-limiting or 200s)', async ({ request }) => {
