...
test.describe('Spritecloud keyboard navigation', () => {
  ...
  test('First tab-focused element shows a visible focus indicator', async ({ page }) => {
    await page.goto('/guides/typescript-its-benefits-use-cases-and-pros-in-testing-as-a-language', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('Escape closes visible dialog and returns focus', async ({ page }) => {
    await page.goto('/guides/typescript-its-benefits-use-cases-and-pros-in-testing-as-a-language', { waitUntil: 'domcontentloaded' })
  ...
  test('Tab from last focusable wraps or exits (no trap)', async ({ page }) => {
