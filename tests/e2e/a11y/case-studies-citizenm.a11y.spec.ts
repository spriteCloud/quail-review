 ...
 *   form-labels   — passes labor labels check for all form inputs
 *
...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/case-studies/citizenm', () => {
  test('@kind:a11y @smoke passes smoke test with no serious or critical violations', async ({ page }) => {
  ...
  test('@kind:a11y @color-contrast passes color-contrast checks per AA threshold', async ({ page }) => {
  ...
  test('@kind:a11y @aria-attrs passes ARIA attribute validation', async ({ page }) => {
  ...
  test('@kind:a11y @form-labels passes labor labels check for all form inputs', async ({ page }) => {
