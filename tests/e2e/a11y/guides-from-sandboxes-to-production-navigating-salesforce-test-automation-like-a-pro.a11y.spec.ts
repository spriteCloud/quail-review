...
test.describe('Spritecloud — Accessibility checks for guide page', () => {
  ...
  test('Accessibility test: WCAG 2.1 AA compliance', async ({ page }) => {
  ...
  test('Accessibility test: color contrast meets AA requirements', async ({ page }) => {
  ...
  test('Accessibility test: ARIA attributes used correctly', async ({ page }) => {
  ...
  test('Accessibility test: all form inputs have labels', async ({ page }) => {
