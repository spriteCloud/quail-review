...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/test-automation', () => {
  test('Keyboard: Tab cycles through the first 10 focusables', async ({ page }) => {
  ...
  test('Keyboard: First focused element has a visible focus indicator', async ({ page }) => {
    await page.goto('/test-automation', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('Keyboard: Escape closes a visible dialog and returns focus', async ({ page }) => {
    await page.goto('/test-automation', { waitUntil: 'domcontentloaded' })
  ...
  test('Keyboard: Enter activates focused links and buttons', async ({ page }) => {
    await page.goto('/test-automation', { waitUntil: 'domcontentloaded' })
  ...
  test('Keyboard: Tab from the last focusable wraps or exits the page', async ({ page }) => {
