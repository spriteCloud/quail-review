...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/case-studies/ben-nl', () => {
  test('@kind:a11y-landmarks smoke: verify single main, h1, and nav elements', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks negative: ensure no focusable elements are inside aria-hidden regions', async ({ page }) => {
    await page.goto('/case-studies/ben-nl', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks heading hierarchy: confirm headings descend sequentially (no skipped levels)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks landmark names: confirm duplicate landmarks carry accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks skip link: verify Skip to Content link is present (WCAG 2.4.1)', async ({ page }) => {
