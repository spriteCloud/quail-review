 ...
 *   no-aria-hidden      — no focusable elements inside elements with aria-hidden subtrees
 *   heading-hierarchy   — headings follow sequential order (no skipped levels) (no h1→h3 jumps)
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/from-sandboxes-to-production-navigating-salesforce-test-automation-like-a-pro', () => {
  test('@kind:a11y-landmarks @smoke exactly one main region, one h1 heading, and at least one nav region', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @negative no focusable elements inside elements with aria-hidden', async ({ page }) => {
    await page.goto('/guides/from-sandboxes-to-production-navigating-salesforce-test-automation-like-a-pro', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks @landmark-names multiple similar landmarks are uniquely named', async ({ page }) => {
