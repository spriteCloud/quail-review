...
test.describe('Spritecloud accessibility checks on /devops page', () => {
  test('no serious or critical axe-core violations', async ({ page }) => {
  ...
  test('color contrast complies with AA threshold', async ({ page }) => {
