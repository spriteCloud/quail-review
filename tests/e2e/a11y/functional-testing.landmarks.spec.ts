...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/functional-testing', () => {
  test('@kind:a11y-landmarks smoke test: single main, single h1, and at least one nav', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks heading hierarchy test: headings follow sequential order', async ({ page }) => {
