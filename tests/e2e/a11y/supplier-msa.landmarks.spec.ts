...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/supplier-msa', () => {
  test('@kind:a11y-landmarks valid structure: exactly one main, one h1, and at least one nav', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks no interactive elements inside aria-hidden sections', async ({ page }) => {
    await page.goto('/supplier-msa', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks headings descend in order (no skipped levels)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks duplicate landmarks are properly named', async ({ page }) => {
