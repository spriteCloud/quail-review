...
test.describe('Spritecloud accessibility on cybersecurity page', () => {
  ...
  test('@kind:a11y WCAG 2.1 AA-only profile compliance', async ({ page }) => {
  ...
  test('@kind:a11y every form input has an accessible label', async ({ page }) => {
