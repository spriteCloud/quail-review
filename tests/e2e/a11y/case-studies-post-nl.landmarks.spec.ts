...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/case-studies/post-nl', () => {
  test('@kind:a11y-landmarks Smoke test: verify single main, h1, and navigation regions', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks Negative test: ensure no focusable elements are inside aria-hidden regions', async ({ page }) => {
    await page.goto('/case-studies/post-nl', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks Heading hierarchy test: ensure headings increase stepwise without skipping levels', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks Landmark names test: verify duplicate landmarks have unique accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks Skip link test: verify "skip to content" affordance forkeyboard navigation (WCAG 2.4.1)', async ({ page }) => {
