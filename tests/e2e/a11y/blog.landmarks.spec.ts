 ...
 *
 *   smoke               — single main region, single h1, at least one nav region
 *   no-aria-hidden      — no focusable elements inside aria-hidden elements
 *   heading-hierarchy   — headings follow sequential order (no skipping levels like h1→h3)
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/blog', () => {
  ...
  test('@kind:a11y-landmarks @headings follow sequential order', async ({ page }) => {
