...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/careers', () => {
  test('@kind:keyboard @smoke navigates through the first 10 focusable elements', async ({ page }) => {
  ...
  test('@kind:keyboard @focus-indicator the first focusable element has a visible focus indicator', async ({ page }) => {
    await page.goto('/careers', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
