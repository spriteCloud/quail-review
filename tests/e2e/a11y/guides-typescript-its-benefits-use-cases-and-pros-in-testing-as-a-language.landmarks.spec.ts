...
test.describe('Spritecloud accessibility landmarks for TypeScript documentation', () => {
  test('single main, h1, and at least one nav region', async ({ page }) => {
  ...
  test('no interactive elements inside aria-hidden regions', async ({ page }) => {
    await page.goto('/guides/typescript-its-benefits-use-cases-and-pros-in-testing-as-a-language', { waitUntil: 'domcontentloaded' })
  ...
  test('headings follow logical sequential order', async ({ page }) => {
