...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/image-patching-with-copacetic', () => {
  test('@kind:a11y-landmarks single main, h1, and at least one nav', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks no focusables may be inside aria-hidden regions', async ({ page }) => {
    await page.goto('/guides/image-patching-with-copacetic', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks headings must follow sequential order (no skipping levels)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks duplicate landmarks must include accessible names', async ({ page }) => {
