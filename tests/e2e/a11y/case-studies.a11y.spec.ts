...
test.describe('Spritecloud accessibly checks for case studies page', () => {
  test('@kind:a11y @smoke axe-core finds no serious or critical violations', async ({ page }) => {
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA checklist passes', async ({ page }) => {
  ...
  test('@kind:a11y @color-contrast contrast rules meet AA requirement', async ({ page }) => {
