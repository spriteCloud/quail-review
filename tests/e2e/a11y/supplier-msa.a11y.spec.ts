 ...
 *   form-labels   — passes form input label check
 *
...
test.describe('Spritecloud — accessibility checks for https://www.spritecloud.com/supplier-msa', () => {
  ...
  test('@kind:a11y @wcag-aa passes WCAG 2.1 AA compliance gate', async ({ page }) => {
  ...
  test('@kind:a11y @color-contrast passes color contrast AA threshold check', async ({ page }) => {
  ...
  test('@kind:a11y @aria-attrs passes ARIA attribute discipline check', async ({ page }) => {
  ...
  test('@kind:a11y @form-labels passes form input label check', async ({ page }) => {
