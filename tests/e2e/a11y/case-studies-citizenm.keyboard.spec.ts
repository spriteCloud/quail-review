...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/case-studies/citizenm', () => {
  test('@kind:keyboard @smoke Tab cycles through the first 10 interactive elements', async ({ page }) => {
  ...
  test('@kind:keyboard @focus-indicator First element focused with Tab shows a visible focus ring', async ({ page }) => {
    await page.goto('/case-studies/citizenm', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @escape-dismiss Escape closes a visible dialog and restores focus to the trigger', async ({ page }) => {
    await page.goto('/case-studies/citizenm', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:keyboard @no-trap Tab from the last interactive element wraps to start or exits the page', async ({ page }) => {
