...
test.describe('Ing — keyboard navigation @ https://www.ing.nl/zakelijk', () => {
  ...
  test('@kind:keyboard @focus-indicator the first tab-focused element is visually focused', async ({ page }) => {
    await page.goto('/zakelijk', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @no-trap Tabbing from the last focusable element moves focus elsewhere', async ({ page }) => {
