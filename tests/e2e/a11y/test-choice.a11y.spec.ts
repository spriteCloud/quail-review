...
test.describe('Spritecloud accessibility — test page at https://www.spritecloud.com/test-choice', () => {
  test('no serious or critical accessibility violations (axe-core smoke test)', async ({ page }) => {
  ...
  test('color contrast satisfies WCAG 2.1 AA thresholds', async ({ page }) => {
