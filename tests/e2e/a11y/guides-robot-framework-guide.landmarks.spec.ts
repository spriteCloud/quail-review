...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/robot-framework-guide', () => {
  ...
  test('@kind:a11y-landmarks @heading-hierarchy: headings must follow sequential order (no skipped levels)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @landmark-names: duplicate landmarks must include accessible names', async ({ page }) => {
