 ...
 *   heading-hierarchy   — headings follow sequential level order (no skips) (no h1→h3 jumps)
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/detox-guide', () => {
  ...
  test('@kind:a11y-landmarks @heading-hierarchy headings follow sequential level order (no skips)', async ({ page }) => {
