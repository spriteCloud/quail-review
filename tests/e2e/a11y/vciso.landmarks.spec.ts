...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/vciso', () => {
  ...
  test('@kind:a11y-landmarks Negative test: no focusable elements inside aria-hidden sections', async ({ page }) => {
    await page.goto('/vciso', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks Heading hierarchy: no skipped levels (e.g., h1→h3)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks Duplicate landmarks must have accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks "Skip to content" link must be present (WCAG 2.4.1)', async ({ page }) => {
