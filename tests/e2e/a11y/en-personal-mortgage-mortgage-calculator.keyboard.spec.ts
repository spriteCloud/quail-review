...
test.describe('Ing — keyboard navigation @ https://www.ing.nl/en/personal/mortgage/mortgage-calculator', () => {
  test('@kind:keyboard @smoke can navigate the first 10 focusable elements using Tab', async ({ page }) => {
  ...
  test('@kind:keyboard @escape-dismiss pressing Escape closes a visible dialog and restores focus to the trigger', async ({ page }) => {
    await page.goto('/en/personal/mortgage/mortgage-calculator', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:keyboard @no-trap Tabbing from the last focusable wraps to the first or exits the page', async ({ page }) => {
