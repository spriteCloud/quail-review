...
test.describe('Ing — accessibility @ https://www.ing.nl/private-banking', () => {
  test('@kind:a11y @smoke passes smoke test with no serious or critical accessibility violations', async ({ page }) => {
  ...
  test('@kind:a11y @color-contrast passes color contrast checks (AA threshold met)', async ({ page }) => {
  ...
  test('@kind:a11y @aria-attrs passes ARIA attribute usage checks', async ({ page }) => {
