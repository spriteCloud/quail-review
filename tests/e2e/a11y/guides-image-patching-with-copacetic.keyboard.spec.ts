...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/guides/image-patching-with-copacetic', () => {
  ...
  test('@kind:keyboard first tabbed element shows a visible focus indicator', async ({ page }) => {
    await page.goto('/guides/image-patching-with-copacetic', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard Escape presses closes a visible dialog and returns focus', async ({ page }) => {
    await page.goto('/guides/image-patching-with-copacetic', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:keyboard Tab from the last focusable wraps or exits the page (no focus trap)', async ({ page }) => {
