...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/performance-testing', () => {
  test('keyboard navigation smoke test: tab through the first 10 focusables', async ({ page }) => {
  ...
  test('keyboard navigation focus indicator test: first focused element has a visible focus indicator', async ({ page }) => {
    await page.goto('/performance-testing', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('keyboard navigation escape dismiss test: Escape closes a visible dialog and returns focus', async ({ page }) => {
    await page.goto('/performance-testing', { waitUntil: 'domcontentloaded' })
  ...
  test('keyboard navigation enter/space test: Enter activates focused links/buttons', async ({ page }) => {
    await page.goto('/performance-testing', { waitUntil: 'domcontentloaded' })
  ...
  test('keyboard navigation focus trap test: Tab from the last focusable wraps or exits the page', async ({ page }) => {
