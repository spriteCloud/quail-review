...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/careers', () => {
  ...
  test('@kind:a11y-landmarks negative test: no focusable elements insidearia-hidden regions', async ({ page }) => {
    await page.goto('/careers', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks heading hierarchy: headings must increase by at most one level at a time', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks landmark names: duplicate landmarks must each have an accessible name', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks skip link: "skip to content" affordance required (WCAG 2.4.1)', async ({ page }) => {
