 ...
 *
 *   smoke               — single <main>, single <h1>, and at least one <nav>
 *   no-aria-hidden      — no focusable elements inside aria-hidden subtrees subtrees
 *   heading-hierarchy   — headings follow sequential ordering (no skipped levels) (no h1→h3 jumps)
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/our-community', () => {
  ...
  test('@kind:a11y-landmarks @heading-hierarchy headings follow sequential ordering (no skipped levels)', async ({ page }) => {
