...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/vciso', () => {
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA-only compliance profile', async ({ page }) => {
  ...
  test('@kind:a11y @color-contrast color contrast passes WCAG 2.1 AA thresholds', async ({ page }) => {
  ...
  test('@kind:a11y @aria-attrs ARIA attribute correctness and usage', async ({ page }) => {
