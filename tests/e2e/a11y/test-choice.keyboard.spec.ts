...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/test-choice', () => {
  test('@kind:keyboard @smoke Tab cycling through up to 10 focusable elements', async ({ page }) => {
  ...
  test('@kind:keyboard @focus-indicator First tab-focused element displays a visible keyboard focus indicator', async ({ page }) => {
    await page.goto('/test-choice', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @escape-dismiss Escape key closes visible dialogs and returns focus to the trigger', async ({ page }) => {
    await page.goto('/test-choice', { waitUntil: 'domcontentloaded' })
