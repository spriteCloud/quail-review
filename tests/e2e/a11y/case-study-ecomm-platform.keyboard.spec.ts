 ...
 *   escape-dismiss  — Escape closes open modal/dialog and returns focus to the trigger
 *   enter-space     — Enter activates links and buttons; Space activates buttons
 *   no-trap         — Tab from the last focusable element wraps or exits the sequence (no trap)
 *
