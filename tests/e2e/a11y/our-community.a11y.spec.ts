...
test.describe('Spritecloud accessibility on community page', () => {
  test('no serious or critical accessibility violations with axe-core', async ({ page }) => {
  ...
  test('color contrast passes WCAG AA threshold', async ({ page }) => {
