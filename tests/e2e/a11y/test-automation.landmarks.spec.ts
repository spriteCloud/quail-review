 ...
 *   heading-hierarchy   — headings increase in order without skipping levels (no h1→h3 jumps)
 *   landmark-names      — multiple landmarks have accessible names
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/test-automation', () => {
  test('@kind:a11y-landmarks @smoke: one <main>, <h1>, and <nav>', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @heading-hierarchy headings increase in order without skipping levels', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @landmark-names: multiple landmarks have accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @skip-link: "skip to content" is present (WCAG 2.4.1)', async ({ page }) => {
