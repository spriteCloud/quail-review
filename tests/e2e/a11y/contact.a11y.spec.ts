...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/contact', () => {
  test('@kind:a11y @smoke smoke test: no serious or critical axe-core violations', async ({ page }) => {
  ...
  test('@kind:a11y @wcag-aa check WCAG 2.1 AA compliance only', async ({ page }) => {
  ...
  test('@kind:a11y @color-contrast verify color contrast meets WCAG AA minimums', async ({ page }) => {
  ...
  test('@kind:a11y @aria-attrs validate correct ARIA usage', async ({ page }) => {
  ...
  test('@kind:a11y @form-labels confirm all form inputs have accessible labels', async ({ page }) => {
