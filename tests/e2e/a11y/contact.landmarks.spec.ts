...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/contact', () => {
  test('@kind:a11y-landmarks @smoke main, h1, and nav present', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @negative no focusables inside aria-hidden regions', async ({ page }) => {
    await page.goto('/contact', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks @landmark-names multiple landmarks have distinguishing names', async ({ page }) => {
