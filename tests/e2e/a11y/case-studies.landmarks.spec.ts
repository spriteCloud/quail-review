...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/case-studies', () => {
  ...
  test('@kind:a11y-landmarks heading hierarchy: headings must increase sequentially (no jumps)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks skip link: “skip to content” affordance must be present (WCAG 2.4.1)', async ({ page }) => {
