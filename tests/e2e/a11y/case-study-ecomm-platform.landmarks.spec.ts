...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/case-study-ecomm-platform', () => {
  test('@kind:a11y-landmarks smoke: single <main>, <h1>, and ≥1 <nav> present', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks heading levels advance by at most one (no skips like h1→h3)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks "skip to content" link or anchor present (WCAG 2.4.1)', async ({ page }) => {
