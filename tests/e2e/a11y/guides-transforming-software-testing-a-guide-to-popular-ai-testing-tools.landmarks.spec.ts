...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/transforming-software-testing-a-guide-to-popular-ai-testing-tools', () => {
  test('@kind:a11y-landmarks @smoke exactly one <main>, one <h1>, at least one <nav>', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @negative no interactables within aria-hidden regions', async ({ page }) => {
    await page.goto('/guides/transforming-software-testing-a-guide-to-popular-ai-testing-tools', { waitUntil: 'domcontentloaded' })
