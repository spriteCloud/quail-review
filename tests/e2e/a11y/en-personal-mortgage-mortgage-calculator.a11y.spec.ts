...
test.describe('ING mortgage calculator page accessibility', () => {
  ...
  test('meets WCAG 2.1 AA accessibility requirements', async ({ page }) => {
  ...
  test('meets AA color contrast requirements', async ({ page }) => {
