 ...
 *   heading-hierarchy   — heading levels advance in sequence without skipping (no h1→h3 jumps)
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/test-management-for-jira-using-xray', () => {
  test('@kind:a11y-landmarks @smoke verify single main region, one h1 heading, and at least one navigation region', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @heading-hierarchy heading levels advance in sequence without skipping', async ({ page }) => {
