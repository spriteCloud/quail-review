...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/guides/image-patching-with-copacetic', () => {
  ...
  test('@kind:a11y WCAG 2.1 AA-only profile check', async ({ page }) => {
  ...
  test('@kind:a11y ARIA attribute discipline check', async ({ page }) => {
  ...
  test('@kind:a11y all form inputs have programmatic labels', async ({ page }) => {
