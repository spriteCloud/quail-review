 ...
 *   form-labels   — form inputs have accessible labels
 *
...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/blog', () => {
  ...
  test('@kind:a11y @wcag-aa meets WCAG 2.1 AA accessibility requirements', async ({ page }) => {
  ...
  test('@kind:a11y @form-labels form inputs have accessible labels', async ({ page }) => {
