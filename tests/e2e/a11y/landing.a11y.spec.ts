...
test.describe('Spritecloud accessibility on www.spritecloud.com', () => {
  ...
  test('@kind:a11y color-contrast — all color contrast meets AA threshold', async ({ page }) => {
  ...
  test('@kind:a11y aria-attrs — no ARIA misuses', async ({ page }) => {
