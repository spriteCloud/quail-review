...
test.describe('Spritecloud accessibility: https://www.spritecloud.com/about-us', () => {
  ...
  test('A11y WCAG 2.1 AA compliance check', async ({ page }) => {
  ...
  test('A11y color contrast: meets WCAG AA threshold', async ({ page }) => {
  ...
  test('A11y ARIA attribute discipline check', async ({ page }) => {
  ...
  test('A11y form labels: every input has a programmatic label', async ({ page }) => {
