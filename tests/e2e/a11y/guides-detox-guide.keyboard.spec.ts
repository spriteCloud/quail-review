...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/guides/detox-guide', () => {
  test('tab cycles through first 10 focusable elements', async ({ page }) => {
  ...
  test('pressing Escape closes a visible dialog and returns focus to the trigger', async ({ page }) => {
    await page.goto('/guides/detox-guide', { waitUntil: 'domcontentloaded' })
  ...
  test('Enter activates focused links or buttons', async ({ page }) => {
    await page.goto('/guides/detox-guide', { waitUntil: 'domcontentloaded' })
  ...
  test('Tabbing past last focusable wraps to start or exits the page', async ({ page }) => {
