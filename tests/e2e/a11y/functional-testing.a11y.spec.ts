...
test.describe('Spritecloud — accessibility tests for functional-testing page', () => {
  ...
  test('WCAG 2.1 AA profile test: only AA rules', async ({ page }) => {
  ...
  test('COLOR CONTRAST test: meets WCAG AA threshold', async ({ page }) => {
  ...
  test('ARIA ATTRIBUTES test: valid and complete ARIA usage', async ({ page }) => {
  ...
  test('FORM LABELS test: each input has a programmatic label', async ({ page }) => {
