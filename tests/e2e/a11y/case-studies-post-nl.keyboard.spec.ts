...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/case-studies/post-nl', () => {
  ...
  test('@kind:keyboard @escape-dismiss Escape closes visible dialogs and restores focus', async ({ page }) => {
    await page.goto('/case-studies/post-nl', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:keyboard @no-trap Tab after the last interactive element wraps or exits the page', async ({ page }) => {
