...
test.describe('Spritecloud accessibility — Smoke, WCAG 2.1 AA, color contrast, ARIA, and form label checks', () => {
  ...
  test('@kind:a11y Color contrast meets WCAG AA minimum', async ({ page }) => {
  ...
  test('@kind:a11y ARIA attribute validation', async ({ page }) => {
