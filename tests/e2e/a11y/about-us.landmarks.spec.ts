...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/about-us', () => {
  ...
  test('@kind:a11y-landmarks heading hierarchy test: headings advance sequentially without skipping levels', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks landmark naming test: multiple landmarks of the same type carry distinguishing accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks skip-link test: keyboard users can bypass repeated navigation blocks', async ({ page }) => {
