...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/contact', () => {
  ...
  test('@kind:keyboard Escape closes a visible dialog and returns focus to the trigger', async ({ page }) => {
    await page.goto('/contact', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:keyboard Tab from the last focusable wraps or exits the page (no trap)', async ({ page }) => {
