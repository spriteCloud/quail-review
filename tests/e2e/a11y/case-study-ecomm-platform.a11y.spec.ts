...
test.describe('Spritecloud accessibility test — case study page', () => {
  ...
  test('Color contrast: all text meets AA threshold', async ({ page }) => {
  ...
  test('ARIA attributes: no misuses detected', async ({ page }) => {
  ...
  test('Form accessibility: all inputs have visible or programmatic labels', async ({ page }) => {
