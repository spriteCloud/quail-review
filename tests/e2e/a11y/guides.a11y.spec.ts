...
test.describe('Spritecloud accessibility on /guides page', () => {
  ...
  test('a11y WCAG 2.1 AA profile check', async ({ page }) => {
  ...
  test('a11y contrast check: meets AA threshold', async ({ page }) => {
  ...
  test('a11y ARIA attributes compliance', async ({ page }) => {
  ...
  test('a11y form labels: all inputs labeled', async ({ page }) => {
