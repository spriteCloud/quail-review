...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} shows content without layout issues`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} remains usable after landscape rotation`, async ({ browser }) => {
