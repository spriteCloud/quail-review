...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} check page loads and loads without layout issues`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} verify page stays usable when rotated to landscape`, async ({ browser }) => {
