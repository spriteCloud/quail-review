...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} screen renders correctly on mobile viewport`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} page stays usable after rotating to landscape`, async ({ browser }) => {
