...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} viewport renders without breaking layout or functionality`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} landscape rotation keeps the page functional and responsive`, async ({ browser }) => {
