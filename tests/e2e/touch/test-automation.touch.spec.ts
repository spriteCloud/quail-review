...
test.describe('Spritecloud — touch gesture smoke tests', () => {
  test('long-press on primary CTA fires click only once', async ({ page }) => {
  ...
  test('horizontal swipe keeps page interactive', async ({ page }) => {
    await page.goto('/test-automation', { waitUntil: 'domcontentloaded' })
  ...
  test('synthesized pinch-zoom keeps page interactive', async ({ page }) => {
    await page.goto('/test-automation', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('rapid vertical swipes don’t break layout', async ({ page }) => {
    await page.goto('/test-automation', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('tap during orientation change doesn’t double-fire', async ({ browser }) => {
