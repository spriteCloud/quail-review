...
test.describe('Spritecloud — Touch gesture tests for performance testing', () => {
  test('Long-press on the primary CTA fires only one click', async ({ page }) => {
  ...
  test('Horizontal swipe leaves the page responsive', async ({ page }) => {
    await page.goto('/performance-testing', { waitUntil: 'domcontentloaded' })
  ...
  test('Synthetic pinch-zoom preserves page interactivity', async ({ page }) => {
    await page.goto('/performance-testing', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('Rapid vertical swipes don’t break the layout', async ({ page }) => {
    await page.goto('/performance-testing', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('Tap during screen rotation doesn’t trigger duplicate clicks', async ({ browser }) => {
